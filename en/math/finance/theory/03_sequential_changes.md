...
### Step 2: The Decrease
This is where the most common conceptual error occurs. The 10% decrease will not be applied to the original $100.00, but rather to the new market value. **The calculation baseline has shifted; the new "100%" is now $110.00.**
...
$$\text{Variation Factor} = \frac{99}{100} = 0.99$$

Since 0.99 represents 99% of the original value, it proves that the net effect of a 10% increase followed by a 10% decrease is, in reality, a **net 1% decrease**:
...
If an asset undergoes a change and is now valued by a factor $f$, to return it to the original baseline of equilibrium (1), it must be multiplied by its inverse:

...
- **Propriedade:** É o único conjunto cuja cardinalidade (tamanho) é estritamente igual a zero ($\vert{}\emptyset\vert{} = 0$).
...
O **Axioma da Fundação** é a trava de segurança do sistema. Ele impede que ocorram cadeias infinitas regressivas na relação de pertinência e proíbe a criação de estruturas autoreferenciadas paradoxais.

...
1. **O Primeiro Elemento ($a$):** É o elemento compartilhado. Ele aparece no subconjunto solitário $\{a\}$ **E** no subconjunto duplo $\{a, b\}$. Ele tem frequência máxima (está em 2 dos 2 subconjuntos).
2. **O Segundo Elemento ($b$):** É o elemento que só aparece no subconjunto expandido $\{a, b\}$. Ele tem frequência menor (está em apenas 1 subconjunto).
...
1. $(\text{Camiseta}, \text{Calça})$
2. $(\text{Camiseta}, \text{Bermuda})$
3. $(\text{Camiseta}, \text{Saia})$
4. $(\text{Camisa}, \text{Calça})$
5. $(\text{Camisa}, \text{Bermuda})$
6. $(\text{Camisa}, \text{Saia})$

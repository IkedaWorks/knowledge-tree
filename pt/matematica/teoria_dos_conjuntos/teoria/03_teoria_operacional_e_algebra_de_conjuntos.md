...
A leitura dessa notação é: _"A é o conjunto de todos os elementos $x$ pertencentes aos números naturais **tais que** $x$ é par e está estritamente entre 0 e 10"_.
...
1. **Todo conjunto é subconjunto de si mesmo:** $A \subseteq A$ é sempre verdadeiro.
    
2. **Se $A = B$:** A afirmação $A \subseteq B$ é **verdadeira**, pois todos os elementos de $A$ estão em $B$. No entanto, a afirmação $A \subsetneq B$ é **falsa**, pois não há elemento exclusivo em $B$.
...
- **O Conjunto Vazio:** O conjunto vazio ($\emptyset$) é subconjunto de qualquer conjunto ($\emptyset \subseteq A, \forall A$), pois a condição _"todo elemento de $\emptyset$ pertence a $A$"_ é vacuamente verdadeira.
...
![Operação de união](../../../../assets/set-theory-union-operator.svg)
...
![](../../../../assets/set-theory-difference-operator.svg)
...
![Complementar Absoluto](../../../../assets/set-theory-complement.svg)
...
> [!NOTE]
> 
> O conjunto universo ($U$) varia conforme o contexto do problema. Embora frequentemente seja o conjunto dos Números Reais ($\mathbb{R}$) em análise e finanças, ele pode ser qualquer domínio bem definido — como um conjunto de pessoas, dados de uma tabela ou todo o plano complexo ($\mathbb{C}$).
...
- **Aplicação Prática:** A negação da condição _"A pessoa mora em São Paulo OU é Cliente Premium"_ equivale a exigir que _"A pessoa NÃO mora em São Paulo E NÃO é Cliente Premium"_.
...
- **Aplicação Prática:** A negação da condição _"A pessoa é Médica E Engenheira"_ equivale a aceitar que _"A pessoa NÃO é Médica OU NÃO é Engenheira"_.

...
> [!WARNING]
> 
> **Nota do Engenheiro:** Esse é o assunto mais importante do cálculo, aqui você vai entender que a integral e a derivada são operações inversas, por meio do TFC, isso é muito importante porque diversas matérias usam derivadas e integrais na mesma equação saber que elas são operações inversa e compreender a função de cada ferramenta, colocará você em outro patamar de compreensão
> 
